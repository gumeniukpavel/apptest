...
class QuestionnaireCompletedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toEmail()
    {
        ...
        $messageModel
            ->setTemplate('emails.questionnaire.questionnaireCompleted')
            ->setSubject(trans('notifications.user.questionnaireCompleted'))
            ->setData([
                ...
                'questionnaireName' => $this->testResult->test->name,
