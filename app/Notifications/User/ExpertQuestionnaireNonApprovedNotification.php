...
class ExpertQuestionnaireNonApprovedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toEmail()
    {
        ...
        return $messageModel->setTemplate('emails.questionnaire.expertQuestionnaireNonApproved')
            ->setSubject(trans('notifications.user.expertQuestionnaireNonApproved'))
            ->setData([
