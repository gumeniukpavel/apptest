...
class ExpertTestApprovedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toEmail(): EmailMessageModel
    {
        ...
        return $messageModel->setTemplate('emails.test.expertTestApproved')
            ->setSubject(trans('notifications.user.expertTestApproved'))
            ->setData([
