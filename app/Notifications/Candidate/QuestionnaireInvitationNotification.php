...
class QuestionnaireInvitationNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    )
    {
        ...
        $this->url = config('app.front_url') . '/user/questioning/' . $this->testResult->access_token;
    }
    ...
    public function toEmail()
    {
        ...
        $messageModel->setTemplate('emails.questionnaire.invitation')
            ->setData([
        ...
        return $messageModel->setSubject(trans('notifications.candidate.questionnaireInvitation'));
    }
